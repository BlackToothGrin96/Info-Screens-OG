...
<div class="main">
	...
	<div class="cell2">
			<div class="title-box">
				<p class="channel-name">Today's Pallets by Carrier Group</p>
...
<!--	</div>-->
	...
	<div class="cell4 rb-info-box columns is-multiline">
		...
		{#each data.pallets_by_courier.slice(0, 6) as info, index}
			<div class="status-spacer column is-full">
	...
	<div class="cell5 rb-info-box columns is-multiline">
		{#each data.pallets_by_courier.slice(6) as info, index}
			<div class="status-spacer column is-full">
				<div class="status-box columns">
					{#if info.name.length > 25}
						<div class="column is-three-fifths status-title" style="font-size: 4rem">
