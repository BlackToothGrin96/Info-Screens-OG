<script>
	...
	import instruction from '$lib/images/totes_oos_instruction.webp';
</script>
...
<div class="main">
	...
	<div class="cell1 rb-info-box">
		<div class="cell-spacer">
			<p class="channel-name">When basket tote picking, you can mark items out of stock or recall orders by pressing the 'issue' button</p>
			<div class="logo">
